# Created by vicente at 29/05/2023
Feature: Admin Interaction
  ...
  Scenario: Add a new pickup point
    Given I am logged in as an admin
    When I click on the add pickup point button
    ...
    And I should see the new pickup point in the list of pickup points